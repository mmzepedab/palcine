...
(function ($) {
	...
	$.fn.countdown = function( method /*,options*/ ) {  
		...
		var defaults = {
				date: (new Date()),
				updateTime: 1000,
				htmlTemplate: "<span class=\"cd-time-number\">%{d}</span> <span class=\"cd-time\">dias</span> <span class=\"cd-time-number\">%{h}</span> <span class=\"cd-time\">horas</span> <span class=\"cd-time-number\">%{m}</span> <span class=\"cd-time\">minutos</span> <span class=\"cd-time-number\">%{s}</span> <span class=\"cd-time\">segundos</span>",
				minus: false,
				onChange: null,
				onComplete: null,
				onResume: null,
