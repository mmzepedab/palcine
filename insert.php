...
if ($row > 0){
    print_r( "Tu ya participaste hoy, puedes regresar mañana a participar de nuevo. MUCHA SUERTE SORTEO 31 DE ENERO");
}else{      
    ...
    if (!mysql_query($sql,$con)){
        ...
        print_r( "Felicidades estas participandos con el numero ".mysql_insert_id()." recuerda que puedes participar una vez al dia, regresa mañana para anotarte de nuevo. MUCHA SUERTE SORTEO 31 DE ENERO");
}
mysql_close($con);
