...
<h2>Salas <?php //echo Yii::app()->createAbsoluteUrl("theater/view", array("id"=>$data->id));?></h2>
                    ...
                    (
                        ...
                        (
                            ...
                            (
                                ...
                                //'url'=>'Yii::app()->request->baseUrl.\'/theater/view/\'.$data->id',
                                'url'=>'Yii::app()->createAbsoluteUrl("theater/view", array("id"=>$data->id))',
                            ),
                        ),
                    ),
	),
